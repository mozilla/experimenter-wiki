...
If you're an iOS or a Fenix developer check the following instructions for how to add new client-side targeting attributes:
- [iOS](ios-custom-targeting.md)
- [Fenix](fenix-custom-targeting.md)
