...
title: Adding new targeting attributes to Fenix
---
# Adding new targeting attributes to Fenix
This page demonstrates how to add new targeting attributes to Fenix, enabling experiment creators more specific targeting.
...
After the targeting attribute is ready on the app, you will need to modify experimenter to allow creating experiments that target the attribute you created. Follow the instructions on [the custom audiences page](console/custom-audiences.md#how-to-add-a-new-custom-audience) to add the new targeting on experimenter.
:::warning
